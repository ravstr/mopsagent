      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-20 max-w-6xl mx-auto text-center">
        <div className="mb-12">
          ...
          <p className="text-base md:text-lg text-gray-700 max-w-4xl leading-relaxed font-medium">
            Marketing Ops isn't about executing anymore — it's about deciding <strong>what</strong> to build and <strong>why</strong>. But most resources still teach the old playbook. MopsAgent is your Socratic AI tutor: it asks the right questions to help you navigate ambiguity and drive business outcomes. Build judgement through guided questions, not prescriptive answers.
          </p>
        </div>
